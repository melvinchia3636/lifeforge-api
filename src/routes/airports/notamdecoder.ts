...
const subjects = [
    {
        ...
        subjects: [
            {
                entity: 'LA',
                subject: 'Approach lighting system (specify runway and type)'
            },
            { entity: 'LB', subject: 'Aerodrome beacon' },
            {
                entity: 'LC',
                subject: 'Runway center line lights (specify runway)'
            },
            { entity: 'LD', subject: 'Landing direction indicator lights' },
            { entity: 'LE', subject: 'Runway edge lights (specify runway)' },
            {
                entity: 'LF',
                subject: 'Sequenced flashing lights (specify runway)'
            },
            {
                entity: 'LG',
                subject: 'Pilot-controlled lighting',
                abbreviations: 'pcl'
            },
            {
                entity: 'LH',
                subject: 'High intensity runway lights (specify runway)'
            },
            {
                entity: 'LI',
                subject: 'Runway end identifier lights (specify runway)'
            },
            {
                entity: 'LJ',
                subject: 'Runway alignment indicator lights (specify runway)'
            },
            {
                entity: 'LK',
                subject:
            ...
            {
                entity: 'LL',
                subject: 'Low intensity runway lights (specify runway)'
            },
            {
                entity: 'LM',
                subject: 'Medium intensity runway lights (specify runway)'
            },
            {
                entity: 'LP',
                subject:
            ...
            {
                entity: 'LU',
                subject: 'Helicopter approach path indicator',
                abbreviations: 'hapi'
            },
            {
                entity: 'LV',
            ...
            {
                entity: 'LX',
                subject: 'Taxiway centre line lights (specify taxiway)'
            },
            { entity: 'LY', subject: 'Taxiway edge lights (specify taxiway)' },
            {
                entity: 'LZ',
                subject: 'Runway touchdown zone lights (specify runway)'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        subjects: [
            ...
            {
                entity: 'FB',
                subject: 'Braking action measurement equipment (specify type)'
            },
            { entity: 'FC', subject: 'Ceiling measurement equipment' },
            {
                entity: 'FD',
                subject: 'Docking system (specify AGNIS, BOLDS, etc.)'
            },
    ...
    },
    {
        ...
        subjects: [
            {
                entity: 'CA',
                subject: 'Air/ground facility (specify service and frequency)'
            },
            {
                entity: 'CB',
                subject:
            ...
            {
                entity: 'CC',
                subject: 'Automatic dependent surveillance — contract (details)'
            },
            {
                entity: 'CD',
                subject:
                    'Controller-pilot data link communications (specify application)'
            },
            { entity: 'CE', subject: 'En route surveillance radar' },
            {
                entity: 'CG',
                subject: 'Ground controlled approach system (GCA)'
            },
            { entity: 'CL', subject: 'Selective calling system (SELCAL)' },
            { entity: 'CM', subject: 'Surface movement radar' },
            {
                entity: 'CP',
                subject: 'Precision approach radar (PAR) (specify runway)'
            },
            {
                entity: 'CR',
                subject:
    ...
    },
    {
        ...
        subjects: [
            {
                entity: 'IC',
                subject: 'Instrument landing system (ILS) (specify runway)',
                type: 'I'
            },
            { entity: 'ID', subject: 'DME associated with ILS', type: 'I' },
            {
                entity: 'IG',
                subject: 'Glide path (ILS) (specify runway)',
                type: 'I'
            },
            {
                entity: 'II',
                subject: 'Inner marker (ILS) (specify runway)',
                type: 'I'
            },
            {
                entity: 'IL',
                subject: 'Localizer (ILS) (specify runway)',
                type: 'I'
            },
            {
                entity: 'IM',
                subject: 'Middle marker (ILS) (specify runway)',
                type: 'I'
            },
            {
                entity: 'IO',
                subject: 'Outer marker (ILS) (specify runway)',
                type: 'I'
            },
            {
                entity: 'IS',
                subject: 'ILS Category I (specify runway)',
                type: 'I'
            },
            {
                entity: 'IT',
                subject: 'ILS Category II (specify runway)',
                type: 'I'
            },
            {
                entity: 'IU',
                subject: 'ILS Category III (specify runway)',
                type: 'I'
            },
            {
                entity: 'IW',
                subject: 'Microwave landing system (MLS) (specify runway)',
                type: 'I'
            },
            {
                entity: 'IX',
                subject: 'Locator, outer (ILS) (specify runway)',
                type: 'I'
            },
            {
                entity: 'IY',
                subject: 'Locator, middle (ILS) (specify runway)',
                type: 'I'
            }
        ]
    },
    {
        ...
        subjects: [
            ...
            {
                entity: 'GW',
                subject: 'GNSS area-wide operations (specify operation',
                type: 'I'
            }
        ]
    },
        ...
        subjects: [
            {
                ...
                area: 'CNS',
                subArea: 'Terminal and En Route Navigation Facilities',
                subject: 'All radio navigation facilities (except...)'
            },
    ...
    },
    {
        ...
        subjects: [
            {
                entity: 'AA',
                subject: 'Minimum altitude (specify en route/crossing/safe)'
            },
            ...
            {
                entity: 'AP',
                subject: 'Reporting point (specify name or entityd designator)'
            },
    ...
    },
    {
        ...
        subjects: [
            {
                entity: 'SA',
                subject: 'Automatic terminal information service (ATIS)'
            },
            ...
            {
                entity: 'SF',
                subject: 'Aerodrome flight information service (AFIS)'
            },
    ...
    },
    {
        ...
        subjects: [
            ...
            {
                entity: 'PL',
                subject: 'Obstacle clearance limit (specify procedure)'
            },
            {
                entity: 'PM',
                subject:
            ...
            {
                entity: 'PU',
                subject: 'Missed approach procedure (specify runway)'
            },
    ...
    },
    {
        ...
        subjects: [
            ...
            {
                entity: 'RD',
                subject: 'Danger area (specify national prefix and number)'
            },
            { entity: 'RO', subject: 'Overflying of ... (specify)' },
            {
                entity: 'RP',
                subject: 'Prohibited area (specify national prefix and number)'
            },
            {
                entity: 'RR',
                subject: 'Restricted area (specify national prefix and number)'
            },
...
const modifiers = [
    {
        ...
        list: [
            {
                status: 'AC',
                modifier: 'Withdrawn for maintenance',
                abbreviations: 'withdrawn maint'
            },
            {
                status: 'AD',
                modifier: 'Available for daylight operation',
                abbreviations: 'avbl day ops'
            },
            {
                status: 'AF',
                modifier: 'Flight checked and found reliable',
                abbreviations: 'fltck okay'
            },
            {
                status: 'AG',
                modifier:
                    'Operating but ground checked only, awaiting flight check',
                abbreviations: 'opr but gnd ck only, awaiting fltck'
            },
            {
                status: 'AH',
                modifier: 'Hours of service are now . . . (specify)',
                abbreviations: 'hr ser'
            },
            {
                status: 'AK',
                modifier: 'Resumed normal operation',
                abbreviations: 'okay'
            },
            {
                status: 'AL',
                ...
                abbreviations: 'opr subj previous cond'
            },
            {
                status: 'AM',
                modifier: 'Military operations only',
                abbreviations: 'mil ops only'
            },
            {
                status: 'AN',
                modifier: 'Available for night operation',
                abbreviations: 'avbl ngt ops'
            },
            { status: 'AO', modifier: 'Operational', abbreviations: 'opr' },
            {
                status: 'AP',
                modifier: 'Available, prior permission required',
                abbreviations: 'avbl, ppr'
            },
            {
                status: 'AR',
                modifier: 'Available on request',
                abbreviations: 'avbl o/r'
            },
            { status: 'AS', modifier: 'Unserviceable', abbreviations: 'u/s' },
            {
                status: 'AU',
                modifier: 'Not available (specify reason if appropriate)',
                abbreviations: 'not avbl'
            },
            {
                status: 'AW',
                modifier: 'Completely withdrawn',
                abbreviations: 'withdrawn'
            },
            {
                status: 'AX',
                modifier: 'Previously promulgated shutdown has been cancelled',
                abbreviations: 'promulgated shutdown cnl '
            }
        ]
    },
    {
        ...
        list: [
            ...
            {
                status: 'CP',
                modifier: 'Operating on reduced power',
                abbreviations: 'opr reduced pwr'
            },
            {
                status: 'CR',
                modifier: 'Temporarily replaced by',
                abbreviations: 'tempo rplcd by'
            },
            { status: 'CS', modifier: 'Installed', abbreviations: 'instl' },
            {
                status: 'CT',
                modifier: 'On test, do not use',
                abbreviations: 'on test, do not use'
            }
        ]
    },
    {
        ...
        list: [
            ...
            }, // 1) Poor 2) Medium/Poor 3) Medium 4) Medium/Good 5) Good
            {
                ...
                abbreviations: 'friction coefficient is'
            },
            {
                status: 'HC',
                modifier: 'Covered by compacted snow to a depth of',
                abbreviations: 'cov compacted sn depth'
            },
            {
                status: 'HD',
                modifier: 'Covered by dry snow to a depth of',
                abbreviations: 'cov dry sn depth'
            },
            {
                status: 'HE',
                modifier: 'Covered by water to a depth of',
                abbreviations: 'cov water depth'
            },
            {
                status: 'HF',
                modifier: 'Totally free of snow and ice',
                abbreviations: 'free of sn and ice'
            },
            {
                status: 'HG',
                modifier: 'Grass cutting in progress',
                abbreviations: 'grass cutting inpr'
            },
            {
                status: 'HH',
                modifier: 'Hazard due to (specify)',
                abbreviations: 'hazard due'
            },
            {
                status: 'HI',
                modifier: 'Covered by ice',
                abbreviations: 'cov ice'
            },
            {
                status: 'HJ',
                modifier: 'Launch planned . . . ',
                abbreviations: 'launch plan'
            },
            {
                status: 'HK',
                modifier: 'Bird migration in progress (specify direction)',
                abbreviations: 'bird migration inpr'
            },
            {
                status: 'HL',
                modifier: 'Snow clearance completed',
                abbreviations: 'sn clr cmpl'
            },
            { status: 'HM', modifier: 'Marked by', abbreviations: 'marked by' },
            {
                status: 'HN',
                modifier: 'Covered by wet snow or slush to a depth of',
                abbreviations: 'cov wet sn/slush depth'
            },
            {
                status: 'HO',
                modifier: 'Obscured by snow',
                abbreviations: 'obscured by sn'
            },
            {
                status: 'HP',
                modifier: 'Snow clearance in progress',
                abbreviations: 'sn clr inpr'
            },
            {
                status: 'HQ',
                modifier:
                    'Operation cancelled . . . (specify balloon flight identification or project code name)',
                abbreviations: 'opr cnl'
            },
            {
                status: 'HR',
                modifier: 'Standing water',
                abbreviations: 'standing water'
            },
            {
                status: 'HS',
                modifier: 'Sanding in progress',
                abbreviations: 'sanding inpr'
            },
            {
                status: 'HT',
                modifier: 'Approach according to signal condition only',
                abbreviations: 'apch according signal'
            },
            {
                status: 'HU',
                modifier: 'Launch in progress . . .',
                abbreviations: 'launch inpr'
            },
            {
                status: 'HV',
                modifier: 'Work completed',
                abbreviations: 'work cmpl'
            },
            {
                status: 'HW',
            ...
            },
            {
                ...
                abbreviations: 'bird concentration'
            },
            {
                status: 'HY',
                modifier: 'Snow banks exist (specify height)',
                abbreviations: 'sn banks hgt'
            },
            {
                status: 'HZ',
                modifier: 'Covered by frozen ruts and ridges',
                abbreviations: 'cov frozen ruts and ridges'
            }
        ]
    },
    {
        ...
        list: [
            {
                status: 'LA',
                modifier: 'Operating on auxiliary power supply',
                abbreviations: 'opr aux pwr'
            },
            {
                status: 'LB',
                modifier: 'Reserved for aircraft based therein',
                abbreviations: 'reserved for acft based therein'
            },
            { status: 'LC', modifier: 'Closed', abbreviations: 'clsd' },
            { status: 'LD', modifier: 'Unsafe', abbreviations: 'unsafe' },
            {
                status: 'LE',
                modifier: 'Operating without auxiliary power supply',
                abbreviations: 'opr aux wo pwr'
            },
            {
                status: 'LF',
                modifier: 'Interference from',
                abbreviations: 'interference fm'
            },
            {
                status: 'LG',
                modifier: 'Operating without identification',
                abbreviations: 'opr wo ident'
            },
            {
                status: 'LH',
                modifier: 'Unserviceable for aircraft heavier than',
                abbreviations: 'u/s acft heavier than'
            },
            {
                status: 'LI',
                modifier: 'Closed to IFR operations',
                abbreviations: 'clsd ifr ops'
            },
            {
                status: 'LK',
                modifier: 'Operating as a fixed light',
                abbreviations: 'opr as f lgt'
            },
            {
                status: 'LL',
                modifier: 'Usable for length of . . . and width of . . .',
                abbreviations: 'usable len.../wid...'
            },
            {
                status: 'LN',
                modifier: 'Closed to all night operations',
                abbreviations: 'clsd to all ngt ops'
            },
            {
                status: 'LP',
                modifier: 'Prohibited to',
                abbreviations: 'prohibited to'
            },
            {
                status: 'LR',
                modifier: 'Aircraft restricted to runways and taxiways',
                abbreviations: 'acft restricted to rwy and twy'
            },
            {
                status: 'LS',
                modifier: 'Subject to interruption',
                abbreviations: 'subj intrp'
            },
            { status: 'LT', modifier: 'Limited to', abbreviations: 'ltd to' },
            {
                status: 'LV',
                modifier: 'Closed to VFR operations',
                abbreviations: 'clsd vfr ops'
            },
            {
                status: 'LW',
                modifier: 'Will take place',
                abbreviations: 'will take place'
            },
            {
                status: 'LX',
                modifier: 'Operating but caution advised due to',
                abbreviations: 'opr but ctn advised due to'
            }
        ]
    },
    {
    ...
    },
    {
        code: 'X',
        condition: 'Other',
        list: [{ status: 'XX', modifier: 'Plain language' }]
    }
]
...
function getISODateString(str: string, format: string) {
    if (format === 'YYMMDDHHmm')
        return new Date(
            Date.UTC(
                Number(String(new Date().getFullYear()).substring(0, 2)) +
...
function findCoordinates(str: string) {
    ...
    if (text.length >= 15) {
        ...
        for (let index = 0; index < text.length - 15; index++) {
            if (
                (text[index + 6] == 'N' || text[index + 6] == 'S') &&
                (text[index + 14] == 'W' || text[index + 14] == 'E')
            ) {
                if (
                    !isNaN(
                        +text.substring(index, index + 6).replace(/[^\d]/g, '0')
                    ) &&
                    !isNaN(
                        +text
                            .substring(index + 7, index + 14)
                            .replace(/[^\d]/g, '0')
                    )
                ) {
                    const c = getCoords(text.substring(index, index + 15))
                    if (c != null) res.push(c)
                }
            }
        }
        ...
        for (let index = 0; index < text.length - 16; index++) {
            if (
                (text[index + 6] == 'N' || text[index + 6] == 'S') &&
                (text[index + 15] == 'W' || text[index + 15] == 'E')
            ) {
                if (
                    !isNaN(
                        +text.substring(index, index + 6).replace(/[^\d]/g, '0')
        ...
        for (let i = 0; i < text.length - 22; i++) {
            if (
                (text[i + 9] == 'N' || text[i + 9] == 'S') &&
                (text[i + 21] == 'W' || text[i + 21] == 'E')
            ) {
                if (
                    !isNaN(+text.substring(i, i + 6).replace(/[^\d.]/g, '0')) &&
                    !isNaN(
                        +text.substring(i + 11, i + 18).replace(/[^\d.]/g, '0')
                    ) &&
                    text.substring(i + 6, i + 7) == '.' &&
                    text.substring(i + 18, i + 19) == '.'
                ) {
...
function getCoords(coordinates: string) {
    if (coordinates.length === 14) {
        //ex: 4025N00404W999
        const lat = convertDMSToDD(
            +coordinates.substring(0, 2).replace(/[^\d]/g, '0'),
            +coordinates.substring(2, 4).replace(/[^\d]/g, '0'),
            0,
            coordinates.substring(4, 5)
        )
        const lng = convertDMSToDD(
            +coordinates.substring(5, 8).replace(/[^\d]/g, '0'),
            +coordinates.substring(8, 10).replace(/[^\d]/g, '0'),
            0,
            coordinates.substring(10, 11)
        )
    ...
    if (coordinates.length === 15) {
        ...
        const lat = convertDMSToDD(
            +coordinates.substring(0, 2).replace(/[^\d]/g, '0'),
            +coordinates.substring(2, 4).replace(/[^\d]/g, '0'),
            +coordinates.substring(4, 6).replace(/[^\d]/g, '0'),
            coordinates.substring(6, 7)
        )
        const lng = convertDMSToDD(
            +coordinates.substring(8, 10).replace(/[^\d]/g, '0'),
            +coordinates.substring(10, 12).replace(/[^\d]/g, '0'),
            +coordinates.substring(12, 14).replace(/[^\d]/g, '0'),
            coordinates.substring(14, 15)
        )
        return [lat, lng]
    }
    if (coordinates.length === 16) {
        // ex: 280944N 0152630W  (16)
        const lat = convertDMSToDD(
            +coordinates.substring(0, 2).replace(/[^\d]/g, '0'),
            +coordinates.substring(2, 4).replace(/[^\d]/g, '0'),
            +coordinates.substring(4, 5).replace(/[^\d]/g, '0'),
            coordinates.substring(5, 16)
        )
        const lng = convertDMSToDD(
            +coordinates.substring(8, 11).replace(/[^\d]/g, '0'),
            +coordinates.substring(11, 13).replace(/[^\d]/g, '0'),
            +coordinates.substring(13, 15).replace(/[^\d]/g, '0'),
            coordinates.substring(15, 16)
        )
        return [lat, lng]
    }
    if (coordinates.length === 22) {
        ...
        const lat = convertDMSToDD(
            +coordinates.substring(0, 2).replace(/[^\d]/g, '0'),
            +coordinates.substring(2, 4).replace(/[^\d]/g, '0'),
            +coordinates.substring(4, 9).replace(/[^\d.]/g, '0'),
            coordinates.substring(9, 10)
        )
        const lng = convertDMSToDD(
            +coordinates.substring(11, 14).replace(/[^\d]/g, '0'),
            +coordinates.substring(14, 16).replace(/[^\d]/g, '0'),
            +coordinates.substring(16, 21).replace(/[^\d.]/g, '0'),
            coordinates.substring(21, 22)
        )
        return [lat, lng]
    } else {
        return null
        ...
        switch (c) {
            case 'N':
                res.push({
                    code: c,
                    description:
                        'Selected for the immediate attention to aircraft operators'
                })
                break
            case 'O':
                res.push({
                    code: c,
                    description: 'Operationally significant for IFR flights'
                })
                break
            case 'B':
                res.push({
                    code: c,
                    description:
                        'For inclusion in Preflight Infomation Bulletins'
                })
                break
            case 'M':
...
function getTraffic(traffic: string) {
    var res = []
...
function convertMessage(msg: string) {
    let mappings: { code: string; index: number }[] = []
    ...
    for (let i = 0; i < mappings.length; i++) {
        let content =
            i < mappings.length - 1
                ? msg.substring(mappings[i].index + 3, mappings[i + 1].index)
                : msg.substring(mappings[i].index + 3)
        res[mappings[i].code.toLowerCase() as keyof typeof res] = content.trim()
    }
    return res
}
...
function parseQualificationLine(q: string) {
    let qualifier: {
        line: string
        code?: {
            code: string
        ...
        location?: string
        traffic?: { code: string; description: string }[]
        purpose?: { code: string; description: string }[]
        scope?: { code: string; description: string }[]
    ...
    if (cols.length == 8) {
        ...
        if (subjectCategoryCode === 'K') {
            ...
            if (subjects) {
                const subjectCategory = subjects.find(
                    c => c.code === subjectCategoryCode
                )
                if (subjectCategory != null) {
                    if (subjectCategory.area != null)
                        qualifier.code.area = subjectCategory.area
                    if (subjectCategory.subArea != null)
                        qualifier.code.subArea = subjectCategory.subArea
                    const subject = subjectCategory.subjects.find(
                        ca => ca.entity === subjectCode
                    )
                    if (subject != null) {
                        if (subject.subject != null)
                            qualifier.code.subject = subject.subject
                    } else {
                        console.warn(
                            'Unable to find subject with code ',
                            subjectCode
                        )
                    }
                } else {
                    console.warn(
                        'Unable to find subject category with code ',
                        subjectCategoryCode
                    )
                }
            }
            if (modifiers) {
                const modifierCategory = modifiers.find(
                    c => c.code === modifierCategoryCode
                )
                if (modifierCategory != null) {
                    if (modifierCategory.condition != null)
                        qualifier.code.condition = modifierCategory.condition
                    const modifier = modifierCategory.list.find(
                        m => m.status === modifierCode
                    )
                    if (modifier != null) {
                        if (modifier.status != null)
                            qualifier.code.status = modifier.status
                        if (modifier.modifier != null)
                            qualifier.code.modifier = modifier.modifier
                    } else {
                        console.warn(
                            'Unable to find modifier with code ',
                            modifierCode
                        )
                    }
                } else {
                    console.warn(
                        'Unable to find modifier category with code ',
...
function parseSchedule(b: string, c: string, d: string) {
    var res: {
    ...
    const bCols = b.split(' ')
    if (bCols.length > 0) {
        res.activityStart = getISODateString(bCols[0], 'YYMMDDHHmm') ?? null
        if (bCols.length > 1) {
            if (bCols[1] == 'EST') {
                // ‘WIE’, ‘SR’ or ‘SS’
    ...
    if (cCols.length > 0) {
        if (cCols[0] == 'PERM') {
            ...
            res.validityEnd = getISODateString(cCols[0], 'YYMMDDHHmm') ?? null
        }
        if (cCols.length > 1) {
            if (cCols[1] == 'EST') {
                res.estimated = true
...
function parseContent(e: string) {
    let res: {
        text: string
        area?: (number[] | (number[] | { radius: number })[])[]
        upper?: string
        lower?: string
    } = {
        text: e
...
function parseLimits(f: string, g: string) {
    // AGL or SFC or AMSL
    if (f != null || g != null) {
        var res: {
            lower?: string
