...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable no-await-in-loop */ /* eslint-disable no-restricted-syntax */
...
router.patch('/add-photos', (0, _asyncWrapper["default"])( /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var pb, photos, isInAlbum, _iterator, _step, id, dim;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 15:
          _context2.next = 17;
          return pb.collection('photos_entry_dimensions').getFirstListItem("photo = \"".concat(id, "\""));
        case 17:
          dim = _context2.sent;
        case 18:
          if (!dim) {
